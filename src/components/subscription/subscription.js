    ...
    <div className="subs-section">
      <div className="subs-section-top">
        <div className="subs-navbar">
          ...
          <div className="subs-navbar-btns">
            <Link to="/redeem">
              <div>
                <p className="subs boarder-styl">Redeem</p>
              </div>
            </Link>
            <Link to="/redeem">
              {" "}
              <div>
                <p className="subs ">MyAccount</p>
              </div>
            </Link>
          </div>
        </div>
        <div className="subs-top-maincontainer">
          <p className="subs-top-title">
            All your music and JioTunes,<span>plus...</span>
          </p>
          <h1 className="subs-top-title-2">
            Ad-free Music, Unlimited Downloads, Exclusive Original Content and{" "}
            <a href="#planDetails">More</a>.
          </h1>
          <div className="subs-top-card-container" id="getplans">
            <div className="subs-card">
              <div className="subs-container-head">
                <strong>JioSaavn</strong>
              </div>
            ...
            <div className="subs-card choosed">
              ...
              <div className="subs-top-container">
                ...
                <div className="sub-payment-btn " id="notclick">
                  Buy Now
                </div>
              </div>
            </div>
      ...
      <div className="subs-mid-container">
        <div className="subs-mid">
          ...
          <h3>
            <em>
              Listen on All of Your Favorite<br></br>
      ...
      <div className="subs-mid-container2" id="planDetails">
        <div className="subs-mid2">
          ...
          <div className="subs-mid-container2-btom">
            ...
            <a className="subs-mid-btom-btn" href="#getplans">
              Pick a Plan
            </a>
          </div>
        </div>
        ...
        <div className="subs-footer-sec">
          ...
          <div className="subs-copyrights">
            <div className="subs-copyrights-socialmedia">
              <a href="https://twitter.com/JioSaavn" target="blank">
                <BsTwitter />
              </a>
              <a href="https://www.facebook.com/JioSaavn" target="blank">
                <FaFacebookF />
              </a>
              <a href="https://www.instagram.com/jiosaavn/" target="blank">
                <BsInstagram />
              </a>
              <a href="https://www.snapchat.com/add/jiosaavn" target="blank">
                <GrSnapchat />
              </a>
              <a href="https://www.youtube.com/c/JioSaavn" target="blank">
                <GrYoutube />
              </a>
            </div>
